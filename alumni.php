...
if ($_user->hasOldUsername())
{
  ...
  if (($year == "UNKNOWN" || $year > 7) || ($alumni_id < $nt_id))   //invalid user            
  {
...
mail('npdoty@gmail.com', "planworld alumni move log", nt: $nt, nt_id: $nt_id, alumni: $alumni, alumni_id: $alumni_id, errors: $errors", "From: NOTE <note@amherst.edu>");
