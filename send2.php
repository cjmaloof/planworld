...
<link rel="alternate stylesheet" type="text/css" media="all" title="highcontrast" href="/planworld/styles/send-hicontrast.css" />
<script language="JavaScript" type="text/javascript" src="/planworld/js/switcher.js"></script>
</head>
...
?>
<div class="<?php echo ($msg['uid'] == $uid) ? 'me' : 'them'; ?>"><span class="name"><?php echo Planworld::idToName($msg['uid']); ?> (<?php echo Planworld::getDisplayDate($msg['sent'], true); ?>):</span> <?php echo nl2br(Planworld::addLinks(htmlentities($msg['message']),$_SESSION['note_user'])); ?></div>
<?php
    } // foreach ($messages as $msg)
?>
<hr />
...
?>
<a href="#" onclick="setActiveStyleSheet(''); return false;">Normal</a> | <a href="#" onclick="setActiveStyleSheet('highcontrast'); return false;">High contrast</a>
</body>
</html>
